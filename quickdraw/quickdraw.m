...
Nval = 5000 ;
N1 = [200 ; 500 ; 1000 ; 1500] ;
N2 = [300 ; 750 ; 1500 ; 2500] ;
...
for idx_iter = 1:n_iter
    for idx_n = 1:length(N1)
        ...
        rangesW.sigma = 10.^linspace(0,4,grid_s) ;
        rangesW.gamma = 10.^linspace(0,8,grid_g) ;
        
        rangesWi.sigma = 10.^linspace(0,5,grid_s) ;
        rangesWi.gamma = 10.^linspace(-2,6,grid_g) ;
        
        rangesL2.sigma = 10.^linspace(5,9,grid_s) ;
        rangesL2.gamma = 10.^linspace(3,10,grid_g) ;
        ...
        save('vals_quickdraw.mat','save_val','-v7.3') ;
