...
for idx_iter = 1:n_iter
    for idx_n = 1:length(N1)
        ...
        rangesW.sigma = 10.^linspace(0,2,grid_s) ; % 25
        rangesW.gamma = 10.^linspace(2,12,grid_g) ; % 10

        rangesWi.sigma = 10.^linspace(0,2,grid_s) ; % 25
        rangesWi.gamma = 10.^linspace(-2,8,grid_g) ; % 10
        
        rangesL2.sigma = 10.^linspace(1,4,grid_s) ; % 25
        rangesL2.gamma = 10.^linspace(3,13,grid_g) ; % 10
