function varargout = compute_mlssvmD_gpu(varargin)
...
%% LSSVM SYSTEM
A = [K + 1/gamma*eye(nx,'single','gpuArray'), ones(nx,1,'single','gpuArray') ; ones(1,ny,'single','gpuArray'), 0] ;
B = [Y; zeros(1,nl,'single','gpuArray')] ;
clear K Y ;
